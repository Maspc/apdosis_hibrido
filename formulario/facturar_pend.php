...
$s = "update registro set estado = 'E' where cargo = '" .$cargo . "'";
...
while($rows = mysql_fetch_array($resulta2))
  ...
  echo "<td> <input type='text' name='precio_venta[]' value='" . $precio_venta1 ."' readonly /><input type='hidden' name='cargo' value='" . $cargo2 ."' readonly /></td>";
  echo "</tr>";
