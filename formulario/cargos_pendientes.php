...
$n = "SELECT registro.no_cama, registro.cargo, registro.fecha_creacion, registro.stat
...
<tr>";
  ...
  $m = "SELECT registro.no_cama, registro.cargo as cargo, registro.fecha_creacion, registro.stat
FROM registro, paciente
WHERE registro.estado = 'P'
AND paciente.id_paciente = registro.id_paciente
