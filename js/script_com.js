...
myNewCell=myNewRow.insertCell(-1);
myNewCell.innerHTML='<td><input type="text" size="10" name="cantidad_bodega_'+cont+'" id="cantidad_bodega_'+cont+'"  value="'+ $("#cantidad_bodega").val() +'" style="text-align:center;" readonly /></td>';
myNewCell=myNewRow.insertCell(-1);
myNewCell.innerHTML='<td><input type="text" size="10" name="cantidad_tienda_'+cont+'" id="cantidad_tienda_'+cont+'"  value="'+ $("#cantidad_tienda").val() +'" style="text-align:center;" readonly /></td>';
myNewCell=myNewRow.insertCell(-1);
myNewCell.innerHTML='<td><input type="text" size="10" name="cantidad_externo_'+cont+'" id="cantidad_externo_'+cont+'"  value="'+ $("#cantidad_externo").val() +'" style="text-align:center;" readonly /></td>';
myNewCell=myNewRow.insertCell(-1);
