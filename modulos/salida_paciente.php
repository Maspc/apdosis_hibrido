<?php
	...
	class salida_p {
		...
		public static function select1($historia) {
			$sql ="SELECT DISTINCT registro.historia, registro.nombre_paciente, registro.cargo, registro.estado, registro.cargo, registro.tratamiento, registro.stat
		...
		public static function select2($historia,$cargo) {
			$sql = "SELECT medicamento, forma_farma, formas_farmaceuticas.descripcion, 
			...
			and registro_detalle.tratamiento = 
