<?php
	...
	class nfc{
		...
		public static function select($carpeta) {
		...
		public static function update1($h,$g,$k,$archivo,$factura) {
			$sql = "update factura set factura_fiscal = '".$h."',
			equipo_fiscal = '".$g."', total = '".$k."' , archivo_fiscal = 
			'".$archivo."', hora_impresion_fiscal = '".date('Y-m-d H:i',time())."' 
			where factura = '".$factura."'";
			conexion::trQry($sql);
			return 1;
		}
		public static function update2($factura) {
