<?php
	...
	require_once('../modulos/actualizar_med_us.php');
	require_once('../modulos/layout.php');
	layout::encabezado();
	layout::menu();
	layout::ini_content();
	
	echo "<body onunload=\"opener.location=('editar_medicamentos_us.php')\">";
	...
	*/
	$resd = amedmed::select1($forma_farma);
