<?php
	...
	require_once('../modulos/estado_cargosatc_aseg.php');
...
?>
<form action="buscar_facturas_aseg.php" method="post" name="estado" id="estado">
			...
			<td>
				<center>
					<table width="510" border="1" cellspacing="0" bordercolor="#000000" align="center">
						...
						<tr>
							<td>Aseguradoras:</td>
							<td> <select name="aseguradora"><?php 
								$gres= estado_ca::select1(); 
								foreach($gres as $grow )
								{	?>
								<option value="<?php echo $grow->codigo_aseg ?>"><?php echo $grow->descripcion ?></option>
							<?php } ?></td>
							</select></tr>
					</table>
				</center>
