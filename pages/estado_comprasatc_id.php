<?php
	...
	//require_once('../modulos/estado_comprasatc_id.php');
	require_once('../modulos/layout.php');
	layout::encabezado();
	layout::menu();
	layout::ini_content();
?>
<form action="buscar_compras.php" method="post" name="estado" id="estado">
		...
		<tr>
			<td>
				...
				<p><p>
					...
					<div align="center">
						<input name="buscar" type="submit" value="Buscar Compras" />  
					</div></td>
				</tr>
			</table>
		</form>
