<?php
	...
	require_once('../modulos/imprimir_orden_compra.php');
	...
	$rowd = iocompra::usuarios($_SESSION['MM_iduser']);
	foreach($rowd as $rd){
		$username = $rd->nombre;
	}
	...
	$pdf->AddCol('medicamento',120,'Artículo');
