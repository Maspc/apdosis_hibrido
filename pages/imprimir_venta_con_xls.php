<?php
	...
	require_once('../modulos/imprimir_venta_con_xls.php');
	...
	fputcsv($output, array('FU', 'ID INTERNO','EQUIPO FISCAL','FACTURA FISCAL', 'FECHA', 'ID PACIENTE', 'NOMBRE', 'TOTAL', 'IMPUESTO'));
	...
	foreach($qres as $qrow){		
		...
		$row = array($fu,$factura,$equipo_fiscal,$factura_fiscal,$fecha,$id_paciente,$nombre_paciente,$total, $impuesto);
