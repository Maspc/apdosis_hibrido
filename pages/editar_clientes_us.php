...
<?php
	...
	require_once('../modulos/editar_clientes_us.php');
	$cont = 0;
...
<div class="content_box_inner">
	<form action="<? $_SERVER['PHP_SELF']; ?>" method="post" name="agregar_med" id="agregar_med">
		...
		<table width="1000" border="0">
			...
			<tr>
				<td>Nombre</td>
				<td><input type="text" name="nombre" id="nombre" size="25"  /></td>
			</tr>
			<tr>
				<td>Apellido</td>
				<td><input type="text" name="apellido" id="apellido" size="25"  /></td>
			</tr>
			<tr>
				<td>Identificacion</td>
				<td><input type="text" name="identificacion" id="identificacion" size="25"  /></td>
			</tr>
			<tr>
				<td>L&iacute;mite de Cr&eacute;dito</td>
				<td><input type="text" name="limite_credito" id="limite_credito" size="25"  /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<input type="submit" value ="Actualizar" name="submit" class="green" /></form>
				<?  
					if(isset($_POST['submit'])){
						...
						clientes::update_cliente($nombre,$apellido,$identificacion,$limite_credito,$tipo_cliente,$codigo_cliente);
						
						echo "<font color='blue'><b>Se ha actualizado con éxito  </b>";
