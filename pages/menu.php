...
<?php if($estado != 'S'){ ?>
		<li class="topfirst"><a href="cierre_carro_hospital.php" style="height:32px;line-height:32px;"><span><img src="default.htm_files/css3menu1/favour.png" alt=""/>Generación de Facturas</span></a></li>
<?php } else {	?>
<li class="topfirst"><a href="cierre_carro_hospital_cierre.php" style="height:32px;line-height:32px;"><span><img src="default.htm_files/css3menu1/favour.png" alt=""/>Generación de Facturas</span></a></li>
<?php } ?>
	...
	<ul>
	<li class="subfirst"><a href="facturacion_label.php" style="height:32px;line-height:32px;"><img src="default.htm_files/css3menu1/favour.png" alt=""/>Impresión de Labels</a></li>
			</ul></li>
	...
	<ul>
		...
		<li><a href="estado_cargosatc_f_fa.php"><img src="default.htm_files/css3menu1/favour.png" alt=""/>Búsqueda por FU</a></li>
...
<ul id="css3menu1" class="topmenu">
	...
	<ul>
		...
		<li><a href="inventario_bajo.php">Pedidos Automáticos</a></li>
...
<?php if($estado != 'S'){ ?>
		<li class="topmenu"><a href="cierre_carro_hospital.php" style="height:32px;line-height:32px;"><span><img src="default.htm_files/css3menu1/favour.png" alt=""/>Generación de Facturas</span></a></li>
<?php } else {	?>
<li class="topmenu"><a href="cierre_carro_hospital_cierre.php" style="height:32px;line-height:32px;"><span><img src="default.htm_files/css3menu1/favour.png" alt=""/>Generación de Facturas</span></a></li>
<?php } ?>
<li class="topmenu"><a href="#"><img src="default.htm_files/css3menu1/favour.png" alt="Cargos"/>Recetario</a>
	<ul>
	<li class="subfirst"><a href="facturacion_label.php" style="height:32px;line-height:32px;"><img src="default.htm_files/css3menu1/favour.png" alt=""/>Impresión de Labels</a></li>
...
<li class="toplast"><a href="logout.php"><img src="default.htm_files/css3menu1/favour.png" alt="Medicamentos"/>Salir</a>
  ...
  <li class="topfirst"><a href="#"><img src="default.htm_files/css3menu1/favour.png" alt=""/>P&uacute;blico</a>
	...
	<li class="topfirst"><a href="facturacion_label.php" style="height:32px;line-height:32px;"><img src="default.htm_files/css3menu1/favour.png" alt=""/>Impresión de Labels</a></li>
			</ul></li>
			<li class="topmenu"><a href="consulta_producto.php" style="height:32px;line-height:32px;"><img src="default.htm_files/css3menu1/favour.png" alt=""/>Consulta Inventario</a></li>
	...
	<li class="topmenu"><a href="perfil_farmaceutico.php" style="height:32px;line-height:32px;"><span><img src="default.htm_files/css3menu1/buy.png" alt=""/>Perfil Farmaceutico</span></a></li>
	<?php if($estado != 'S'){ ?>
		<li class="tomenu"><a href="cierre_carro_hospital.php" style="height:32px;line-height:32px;"><span><img src="default.htm_files/css3menu1/favour.png" alt=""/>Generación de Facturas</span></a></li>
<?php } else {	?>
<li class="topmenu"><a href="cierre_carro_hospital_cierre.php" style="height:32px;line-height:32px;"><span><img src="default.htm_files/css3menu1/favour.png" alt=""/>Generación de Facturas</span></a></li>
<?php } ?>
		<?php if($estado != 'S'){ ?>
	...
	<ul>
		...
		<li><a href="estado_cargosatc_f_fa.php"><img src="default.htm_files/css3menu1/favour.png" alt=""/>Búsqueda por FU</a></li>
			...
			<li><a href="devolucion_pub_manual.php" style="height:32px;line-height:32px;"><img src="default.htm_files/css3menu1/favour.png" alt=""/>N/C Manuales</a></li>
				...
				<ul>
		<li class="subfirst"><a href="usuarios.php"><img src="default.htm_files/css3menu1/favour.png" alt=""/>Creación de Usuarios</a></li>
		...
		<li><a href="usuarios_editar.php" style="height:32px;line-height:32px;"><span><img src="default.htm_files/css3menu1/favour.png" alt=""/>Editar Usuarios</span></a></li>	
							...
							<li class="topmenu"><a href="#"><img src="default.htm_files/css3menu1/favour.png" alt="Artículos"/>Art&iacute;culos</a>
			<ul>
		<li class="subfirst"><a href="agregar_medicamentos_us.php">Agregar Medicamentos</a></li>
		<li><a href="editar_medicamentos_us.php">Editar Medicamentos</a></li>
	...
	<ul>
		...
		<li><a href="sugerencias_farma.php">Sugerencias de Hospital</a></li>
			<li><a href="imprimir_med_snposo.php">Medicamentos sin Posología</a></li>
				<li><a href="imprimir_med_sninve.php">Medicamentos sin Inv. Crítico/Mínimo</a></li>
	...
	<li class="subfirst"><a href="imprimir_med.php" target="_blank">Listado de Medicamentos</a></li>
		...
		<li><a href="imprimir_med_imp.php" target="_blank">Listado de Medicamentos de Importación</a></li>
		...
		<li><a href="cambio_costo_fecha.php">Variación de Costos por Fecha</a></li>
...
<li class="topmenu"><a href="#"><img src="default.htm_files/css3menu1/favour.png" alt="Cargos"/>Recetario</a>
	...
	<ul>
		<li class="subfirst">
		<a href="compras_detalle.php">Ingreso de Mercancía</a></li>	
			<li><a href="traslado_ins_med.php">Traslado de Insumos a Medicamentos</a></li>
		<li><a href="traslado_med_ins.php">Traslado de Medicamentos a Insumos</a></li>	
			</ul></li>
