<?php
	...
	//require_once('../modulos/estado_cargosatc_id.php');
...
?>
<form action="buscar_facturas.php" method="post" name="estado" id="estado">
			...
			<td>
				<center>
					<table width="510" border="1" cellspacing="0" bordercolor="#000000" align="center">
						...
						<tr>
							<td>Tipo de Facturaci&oacute;n:</td>
							<td><select name="tipo"><option value="1">Mostrar Todo</option><option value="2">Mostrar Hospital</option><option value="3">Mostrar P&uacute;blico</option></select></td>
						</tr>
					</table>
				</center>
				<p><p>
