<?php
	...
	$rsd = getgen::get_medicamento_edit_inv($q);
	$return_arr = array();
	...
	foreach($rsd as $rs){
		...
		//echo "$mdesc|$mid|$mmin|$mmax|$mideal|$mmcrit|$mcantini|$mcantfact|$mcantdev|$mcostouni|$mpreciouni|$mporcgana|$mcodi|$mexist|$mpreciounip\n";
