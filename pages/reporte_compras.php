<?php
	...
	layout::ini_content();
?>
<center><h1>Reporte de Entradas y Salidas de Mercanc&iacute;a</h1></center><p>&nbsp;</p><p>&nbsp;</p>
<center>
	<p style="margin-left: 20"><font face="Arial" size="2" color="#000000">Introduzca la fecha que desea buscar</font></p>
	<form target="_blank" action="imprimir_compras_xls.php" method="post" name="venta" id="venta">
		...
		<p>
			...
			<p>
				<p>&nbsp;</p>
				Medicamento: <input sformat size="100" id="medicamento" name="medicamento" type="text" required /><input size="100" id="medicamento_id" name="medicamento_id" type="hidden"/>
				<p>&nbsp;</p>
