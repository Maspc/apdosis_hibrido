...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<script type="text/javascript">
		...
		<div class="content_box_inner" style="font-size:16px" align="center">
			...
			<form method="post" action="add_prove.php" name="formulario" onsubmit="return validate();">
				<table align="center">
			...
			<table id="dtable" border="1" align="center">
				<tr><th>Nombre</th><th>Contacto</th><th>Telefono</th><th></th><th></th></tr>
				<?php
					...
					<tr>
						...
						<td><?=$pr->contacto?></td>
						<td><?=$pr->telefono?></td>
						<td style="width: 5px;"><a href="#" class="fa fa-remove" onclick="confirmation('delete_prove.php<?='?id='.$pr->id_proveedor?>')" title="Borrar"></a></td>
						<td style="width: 5px;"><a class="fa fa-edit" href="edit_prove.php<?='?id='.$pr->id_proveedor?>" title="Editar"></a></td>
					</tr>
				<?php }?>
			</table>
