...
<div class="content_box_inner" style="font-size:16px">
	...
	<form method="post">
		<table align="center">
			...
			?>
			<tr><td>Nombre:</td><td><input type="text" name="nombre" value="<?=$prove_rows[0]->nombre_proveedor?>"></td></tr>
			<tr><td>RUC:</td><td><input type="text" name="ruc" value="<?=$prove_rows[0]->ruc?>"></td></tr>
...
<?php 
	...
	if (isset($_POST['submit'])){
		...
		provee::update_provee($nombre,$ruc,$contacto,$telefono,$id);
