<?php
	...
	require_once('../modulos/orden_compras_detalle.php');
...
<div>
	...
	<h2>A&ntilde;adir Orden de Compra</h2>
	<div class="content_box_inner">
		...
		<form action="enviar_orden_compra.php" method="post" target="" name="formulario" id="formulario" >
				...
				<thead>
					...
					<tbody>
						<tr>
							...
							<td><input name="codigo_de_barra" type="text" id="codigo_de_barra" size="50"/>
							<b>*</b></td>
						</tr>
						<tr>
							<td>Art&iacute;culo</td>
							<td><input name="medicamento" type="text" id="medicamento" size="75"/>
							<input name="medicamento_id" type="hidden" id="medicamento_id" size="50" /> <input type="button" name="agregar_medicamento" value="Agregar Medicamento" id="agregar_medicamento" onClick="javascript:popUp('agregar_medicamentos_us.php')" /> <input type="button" name="agregar_insumo" value="Agregar Producto" id="agregar_insumo" onClick="javascript:popUp('agregar_insumos.php')" /> <b>*</b></td>
						</tr>
					</tr>
					<td>Cantidad Mínima a Proveedor Principal</td>
					<td><input name="cant_max_prov" type="number" id="cant_max_prov" size="25" readonly />
					</td>
				</tr>
				<td>Cantidad</td>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#medicamento").autocomplete({
			...
			$("#cantidad").val(data.cant_max_prov);
			}
		});
...
<script language="javascript" type="text/javascript" src="../js/script_com_or.js?r=<?=rand()?>"></script>	