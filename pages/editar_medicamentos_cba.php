...
<?php
	ob_start();
	require_once('../modulos/editar_medicamentos_cba.php');
...
<center>  <h1>Imprimir C&oacute;digos de Barra para Anaquel</h1> </center>
<div class="content_box_inner">
	
	
	<p>Imprimir todos los c&oacute;digos: <input type="button" name="codigos_todos" id="codigos_todos" value="Imprimir Todos" onClick="parent.location='imprimir_codigo_precio.php'" > </p>
	<p>Impresi&oacute;n individual:</p>
	<form id="form" name="form" method="post" action="<?php $_SERVER['PHP_SELF']; ?>">
		...
		<?php
			if (isset($_POST['buscar'])){
				...
				echo   "<form id='form1' name='form1' method='post' action='imprimir_codigo_precio_u.php' onSubmit=\"popupform(this, 'join')\" >
