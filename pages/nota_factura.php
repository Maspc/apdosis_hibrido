...
<div>
	...
	<h2>Notas de Crédito por Factura</h2>
	
	
	<div class="content_box_inner">
		<form name="perfil" action="imprimir_fiscal_dev_fact.php" method="post">
			
			<p>Referencia Factura: <select name="tipo"><option value="1">FACTI</option><option value="2">FACTIC</option></select> <input type="text" name="id" id="id" size="20" class="required" />
				<p>
					...
					<p> Número de Factura Fiscal: <input type="text" name="factura_fiscal" class="required"> 
