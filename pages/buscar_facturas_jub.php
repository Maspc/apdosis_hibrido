<?php
	...
	require_once('../modulos/buscar_facturas_jub.php');
	...
	{
		$where[] = "a.fecha between '".$_POST['fecha_inicio']."' and '".$_POST['fecha_fin']."' and a.jubilado='S' and a.descuento_total > 0";
	...
	{
		$where[] = "a.fecha between '".$_GET['fecha_inicio']."' and '".$_GET['fecha_fin']."' and a.jubilado='S' and a.descuento_total > 0";
	...
	$kores = buscarfj::select3($where,$compag,$CantidadMostrar);
	
	if ($factura == 0) {
		echo "<center><h3>Movimientos de Descto. de Jubilados desde el ".$fecha_inicio." hasta el ".$fecha_fin."</h3></center>";
		} else {
