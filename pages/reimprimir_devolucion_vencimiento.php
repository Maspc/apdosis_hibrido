<?php
	...
	class PDF extends PDF_MySQL_Table
	{
		function Header()
		{
			...
			$titulo = 'Reimpresion de Devolución por Vencimiento - '.$nom_cia;
	...
	$rowd = reimpridev::usuarios($_SESSION['MM_iduser']);
	foreach($rowd as $rw){
		$username = $rw->nombre;
	}	
	...
	$row = reimpridev::total($z);
	foreach($row as $rw1){
		$pdf->Write(5,'Total de la devolucion: '.$rw1->total);
	}
